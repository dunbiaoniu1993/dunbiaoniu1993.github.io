...
• Participate in several of Professor Song’s projects in collaboration with diverse technicians and scientists
from both academia and industry.  

2016.09-2019.06 | Sichuan University, China   
College of Mathematics M.A. in Probability Theory and Mathematical Statistics  
• Thesis: An Approach based on Polyhedron to Set-membership Estimation (Advised by Professor Enbin
Song)  
• Participated in the discussion and programming of collaborators' research projects, and worked closely
with collaborators on numerical experiments from conception to publication.  
• Engaged as a teaching assistant for courses in linear algebra, probability theory, and mathematical
statistics for undergraduates.  


2012.09-2016.06 | Southwest Jiaotong University, China  
School of Mathematics B.S. in Statistics  
• Thesis: Support Vector Machines and Their Application to Pattern Recognition (Advised by Associate
...
• Participated in the 11th China Information Fusion Conference, 44th and 43rd China Control Conference, etc., and gave academic reports at these conferences;  
